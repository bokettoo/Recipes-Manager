...
## Features
- **Home page**:<br><br>
    <img src="assests/home.jpg" alt="Your Image" width="700">
- **Add Recipe**: Users can add new recipes by providing recipe name, type, ingredients, and instructions.<br><br>
    <img src="assests/addjpg.jpg" alt="Your Image" width="700">
- **Search Recipe**: Users can search for recipes by name and view the details of the matching recipes.<br><br>
    <img src="assests/search.jpg" alt="Your Image" width="700">
- **Shuffle Recipes**: Users can shuffle and view a random recipe based on the selected recipe type.<br><br>
    <img src="assests/shuffle.jpg" alt="Your Image" width="700">
- **Manage Recipes**: Users can view, edit, and delete existing recipes.<br><br>
    <img src="assests/manage.jpg" alt="Your Image" width="700">
